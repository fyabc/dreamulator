...
| 偏心率阻尼时标 τ_e | **1.4 Myr** | (2/21)(Q/k₂)(M_m/M_p)(a/R)⁵(1/n) |

> 148 TW ≈ **3.1× 地球总热流**（47 TW），是 Nacrea 主导热源（~85%），驱动板块构造与
> 碳-硅酸盐循环。热流密度 0.25 W/m² 介于地球（0.09）与 Io（2.4）之间——活跃但不至岩浆海。
> τ_e = 1.4 Myr 意味着**共振链一旦断裂，e 在百万年尺度内归零**（详见 `satellite_architecture.md`）。
...
| Cadence（会合） | 6.29 d | 3.47×10⁻⁶ | 4.2% |
| Ignis（恒星） | 100 d | 1.90×10⁻⁶ | 2.3% |
| Vigil（会合） | 12.59 d | 1.11×10⁻⁷ | 0.13% |

**整体潮汐规律**：

1. **主潮**：Aegis 偏心率潮，周期 3.147 d，占 ~95% 动态潮汐。
...
4. **关键周期**：3.147 d（主潮）、6.29 d（Cadence 会合）、12.59 d（Vigil 会合）、
...
| 影响 | 机制 | 待办关联 |
|------|------|---------|
| 潮汐历 | 3.147 / 6.29 / 12.59 / 100 d 四重周期是历法、宗教、农业的核心节律 | 文明种子设计 |
