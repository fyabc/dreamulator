...
| 参数 | 值 | 推导依据 |
|------|-----|---------|
| 恒星在 Aegis 处的辐照度 | **655.8 W/m²** | L_star / (4πa_p²)；L=0.0357 L☉, a=0.2722 AU（轨道内移校准后） |
| Aegis 满相照度（Gaia-M 表面） | **1.393 W/m²** | F_star × A_g × (R_p/a_m)² = 655.8 × 0.228 × 9.32×10⁻³ |
| 满相 = 地球满月倍数 | **1161 倍** | 1.393 / 0.0012 |
| 半相（90°）= 地球满月倍数 | **370 倍** | 朗伯球体相位函数 Φ(90°) |
| 极细相（170°）= 地球满月倍数 | **0.63 倍** | Φ(170°) ≈ 5.6×10⁻⁴ |
