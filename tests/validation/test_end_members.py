...
# Mars: 1.524 AU, albedo 0.25, 6 mbar CO2, ~3 K greenhouse.  e = 0.093 exercises
# the eccentricity insolation path (southern-hemisphere-winter-dominated cycle).
_MARS = {
    "stellar_luminosity_sol": 1.0,
...
def test_nacrea_hz_center_is_not_snowball():
    ...
    habitable = [k for k in stats["koppen_counts"] if k[:1] in ("A", "B", "C")]
