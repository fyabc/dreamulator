...
- **遗留**：① 利雅得等高原沙漠（~600m）仍被 6.5°C/km 海拔递减率过冷 ~3-4°C（独立项）；
  ② 丹佛/乌鲁木齐中纬大陆度冷属 4.1-B 范畴，非本节（本节只修副热带下沉 + 赤道过暖）。
...
**候选**：引入动力学副热带高压（热带暖区下沉 → 高压单体）→ 恢复地转风/静止波；或海陆
加热差异驱动的纬向气压梯度。与 §7 冬季风、技术债 23 同源（都缺纬向不对称），
「收益较大但工程较大」，先标记、不单独落地。
