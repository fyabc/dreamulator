...
| **P0** | **季风动力学与季节风场**（技术债 23，§七）：v1 已落地；2026-09-13 全球偏差审查实锤季风幅度 = 全球最大错配流（C→B 3572 格：恒河 ΔP −1104 / 华南 −1345 / 美东南 −1205 mm，Cfa/Cwa recall ≈0，美东南 88% 判 BWh）——**当前主动项 = 季风幅度**（§2 高地热源 ΔP 底稿，与技术债 24 捆绑标定；验收 Cwa/Cfa/Am recall >40% + 恒河/华南 ΔP 收敛）；**副高西缘流（美洲 Cfa）= 条件项**：仅当 ΔP 框架自然延伸覆盖才做，需逐区特调/复杂定常涡旋求解器则放弃登记局限；环流胞圈逐月迁移与月度矢量场（技术债 24）合并推进，见 [climate-layer-improvement.md](proposals/climate-layer-improvement.md) §2 审计小节 | 剩余 1–2 周（随 24） | ★★★★★ |
...
24. **月度矢量场：风场先行、洋流不伪造**（2026-08-28，与 23 同源）— 现状：
    ...
    - **镜像 bug ✅ 已修复（2026-09-12，`31837a9`）**：`_compute_precipitation_monthly_budget`
      ...
      迎风:背风 + 下行风羽流）。**归本条的剩余部分**：根部约定统一（镜像东基根除）+
      季风模块 f→−f 次级泥潭——随月度矢量场轮全库裁决清理。
