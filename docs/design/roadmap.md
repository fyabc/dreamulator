...
| 子任务 | 说明 | 验证目标 |
|--------|------|---------|
| 风生表面流 | current = rotate(wind, 45°×sign(lat)) × 0.02 | 五大环流圈形态 |
| 西边界强化 | 环流圈西侧流速 ×3 | 东岸暖流识别（Gulf Stream / 黑潮型） |
| 沿岸热输送 | 暖流 +3~8°C / 寒流 -2~5°C，衰减 ~500km | 西欧冬季偏暖 |
| 上升流 | 东边界离岸风 → 冷水上涌 → 降温减湿 | 纳米布 / 阿塔卡马更干冷 |
| 季风洋流反转 | 流向季节反转（索马里洋流型）+ SST 季节滞后 1–2 月 | 季风区洋流季节反转 |
