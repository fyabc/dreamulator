...
**速度大小**随 P 到欧拉极的角距离变化（自 design/terrain-pipeline.md §4.3 与
附录 A.3 上浮，2026-08）：
...
**角速度-线速度换算**（自 design/terrain-pipeline.md §4.2 上浮，2026-08）：
...
**各类型的地质效应**（自 design/terrain-pipeline.md §5.4 上浮，2026-08）：
