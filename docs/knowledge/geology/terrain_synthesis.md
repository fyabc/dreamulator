...
> 详细算法参考：`docs/design/geological-pipeline.md` §6
...
**地球物理依据**（自 design/geological-pipeline.md §6.1 上浮，2026-08）：
...
（自 design/geological-pipeline.md §6.2 上浮，2026-08。以下为管线设计阶段的示意
...
**距边界粗糙度调制**（自 design/geological-pipeline.md §6.3 上浮，2026-08）：
...
**Octave 物理尺度对照**（自 design/geological-pipeline.md §6.4 上浮，2026-08；
...
**地幔柱/超级隆起设计参考**（自 design/geological-pipeline.md §6.5 上浮，2026-08）：
...
**沿走向高度调制与山间盆地**（自 design/geological-pipeline.md §6.7 上浮，2026-08）：
...
| `interior_lowland_floor_m` | 50 | 下压后离海平面最低高度（m） |
...
（自 design/geological-pipeline.md §6.6 上浮，2026-08）
...
| `interior_lowland_floor_m` | 50 | 内部低地 |
