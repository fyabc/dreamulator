...
export const CONTROL_HELP: ControlHelpEntry[] = [
  ...
  { action: '光照·时刻滑块', description: '调整太阳直射经度（周日变化，0° = 本初子午线正午），即昼夜明暗界线的位置。仅 3D 球面视图。' },
  { action: '光照·季节滑块', description: '调整轨道位置（周年变化，0° = 春分，90° = 北半球夏至）。结合地轴倾角改变太阳直射纬度，使明暗界线随季节倾斜（极地出现极昼/极夜）。无倾角的行星无季节变化。仅 3D 球面视图。' },
