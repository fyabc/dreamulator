...
export const LAYER_GROUPS: { id: string; label: string; icon: string }[] = [
  ...
  { id: 'dev', label: 'help:layerGroup.dev', icon: '🧪' },
]
...
export const LAYER_HELP: LayerHelpEntry[] = [
  ...
  {
    id: 'pressureError',
    label: 'help:layer.pressureError.label',
    desc: 'help:layer.pressureError.desc',
    detail: 'help:layer.pressureError.detail',
    defaultOpacity: 0.85,
    kind: 'thematic',
    group: 'dev',
    devOnly: true,
  ...
  {
    id: 'windError',
    label: 'help:layer.windError.label',
    desc: 'help:layer.windError.desc',
    detail: 'help:layer.windError.detail',
    defaultOpacity: 0.85,
    kind: 'feature',
    group: 'dev',
    devOnly: true,
  ...
  {
    id: 'currentError',
    label: 'help:layer.currentError.label',
    desc: 'help:layer.currentError.desc',
    detail: 'help:layer.currentError.detail',
    defaultOpacity: 0.85,
    kind: 'feature',
    group: 'dev',
    devOnly: true,
