...
const PLANET_TYPE_LABELS: Record<string, string> = {
  terrestrial: 'planetTypeShort.terrestrial',
  gas_giant: 'planetTypeShort.gas_giant',
  ice_giant: 'planetTypeShort.ice_giant',
  ocean_world: 'planetTypeShort.ocean_world',
  dwarf: 'planetTypeShort.dwarf',
}
...
export default function PlanetMesh({
  ...
  const typeKey = PLANET_TYPE_LABELS[planet.planet_type ?? '']
  const typeLabel = typeKey ? t(typeKey) : (planet.planet_type ?? '')
