...
export type ColorMode = 'terrain' | 'landsea' | 'plates' | 'boundaries' | 'coastlines' | 'rivers' | 'koppen' | 'currents' | 'winds' | 'biomes' | 'npp' | 'domesticable' | 'soil' | 'provinces' | 'temperature' | 'precipitation' | 'temperatureError' | 'precipitationError' | 'pressureError' | 'windError' | 'currentError' | 'pressure' | 'habitable' | 'agriculture' | 'flow'
...
export default function useTerrainTexture({
  ...
  return useMemo(() => {
    ...
    // (Graticule is drawn by the SVG overlay, not on this texture.)
