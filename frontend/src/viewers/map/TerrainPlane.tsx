...
export type ColorMode = 'terrain' | 'landsea' | 'plates' | 'boundaries' | 'coastlines' | 'rivers' | 'koppen' | 'currents' | 'winds' | 'biomes' | 'npp' | 'domesticable' | 'soil' | 'provinces' | 'temperature' | 'precipitation' | 'habitable' | 'agriculture' | 'flow'
