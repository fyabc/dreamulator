...
Usage:
    uv run python scripts/climate/convert_koppen_map.py [--tif PATH] [--mesh PATH] [--output PATH]
...
def main() -> None:
    ...
    if not mesh_path.exists():
        ...
        print("Run: uv run python scripts/earth/import_earth_elevation.py first", file=sys.stderr)
        sys.exit(1)
