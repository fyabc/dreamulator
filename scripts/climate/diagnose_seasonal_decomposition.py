...
Usage::
    ...
    uv run python scripts/climate/diagnose_seasonal_decomposition.py
    uv run python scripts/climate/diagnose_seasonal_decomposition.py --world-dir data/worlds
"""
