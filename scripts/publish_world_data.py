...
Usage::
    ...
    uv run python scripts/publish_world_data.py                  # rebuild all + publish
    uv run python scripts/publish_world_data.py --worlds nacrea  # rebuild one world
    uv run python scripts/publish_world_data.py --skip-build     # publish only (already built)
    uv run python scripts/publish_world_data.py --dry-run        # build + package, no upload
"""
