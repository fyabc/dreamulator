...
Usage::
    ...
    uv run python scripts/dev/check_doc_refs.py                 # scan docs/design/pipelines
    uv run python scripts/dev/check_doc_refs.py --docs docs/design/pipelines docs/usage
