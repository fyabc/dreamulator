...
Usage:
    python scripts/dev/prepare_civmap_data.py \
...
Examples:
    ...
    python scripts/dev/prepare_civmap_data.py --source natural-earth

    # Download geoBoundaries ADM1 (larger, CC BY 4.0)
    python scripts/dev/prepare_civmap_data.py --source geoboundaries --level adm1

    # With geometry simplification (requires geopandas + shapely)
    python scripts/dev/prepare_civmap_data.py --source natural-earth --simplify 0.01
"""
