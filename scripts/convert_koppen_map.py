...
def main() -> None:
    ...
    parser.add_argument(
        "--mesh",
        default="data/worlds/earth/branches/climate-dev/layers/geological/input/maps/earth/cvt_mesh.json",
        help="Path to CVT mesh JSON",
    )
    parser.add_argument(
        "--output", "-o",
        default="data/worlds/earth/branches/climate-dev/layers/climate/reference/koppen_obs.json",
